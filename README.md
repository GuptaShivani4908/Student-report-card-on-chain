u# Student Report Card on Chain
...
- **Transcript Aggregation**: Support multiple subjecthhhs and terms per student.hh
...
- **Decentralized Frontend**: UI integration using Stellar's Soroban frontend tools.j
## Contract Details
